...
/////////////////////////////////////////////////////
// ASpriteAtlasPackerWidgetActor

ASpriteAtlasPackerWidgetActor::ASpriteAtlasPackerWidgetActor(const FObjectInitializer& ObjectInitializer)
    : Super(ObjectInitializer)
{
    ...
    SpriteAtlasPackerComponent = CreateEditorOnlyDefaultSubobject<USpriteAtlasPackerComponent>(TEXT("SpriteAtlasVisualizer"));
    if (SpriteAtlasPackerComponent)
    {
        SpriteAtlasPackerComponent->SetupAttachment(RootComponent);
    }
}

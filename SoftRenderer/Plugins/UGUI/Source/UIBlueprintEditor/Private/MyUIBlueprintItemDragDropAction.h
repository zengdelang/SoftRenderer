...
class UIBLUEPRINTEDITOR_API FMyUIBlueprintItemDragDropAction : public FGraphSchemaActionDragDropAction
{
public:
	DRAG_DROP_OPERATOR_TYPE(FMyUIBlueprintItemDragDropAction, FGraphSchemaActionDragDropAction)
...
protected:
	 /** Constructor */
	FMyUIBlueprintItemDragDropAction();

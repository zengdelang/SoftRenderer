...
/////////////////////////////////////////////////////
// UBackgroundGlitchSubComponent

UBackgroundGlitchSubComponent::UBackgroundGlitchSubComponent(const FObjectInitializer& ObjectInitializer)
...
void UBackgroundGlitchSubComponent::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
    const FName MemberPropertyName = PropertyChangedEvent.MemberProperty ? PropertyChangedEvent.MemberProperty->GetFName() : FName();
    if (MemberPropertyName == GET_MEMBER_NAME_CHECKED(UBackgroundGlitchSubComponent, bUseGlitch))
    {
        SetUseGlitch(bUseGlitch);
    }
    else if (MemberPropertyName == GET_MEMBER_NAME_CHECKED(UBackgroundGlitchSubComponent, Strength))
    {
        SetStrength(Strength);
    }
    else if (MemberPropertyName == GET_MEMBER_NAME_CHECKED(UBackgroundGlitchSubComponent, Method))
    {
        SetMethod(Method);
    }
    else if (MemberPropertyName == GET_MEMBER_NAME_CHECKED(UBackgroundGlitchSubComponent, DownSampleAmount))
    {
        SetDownSampleAmount(DownSampleAmount);
    }
    else if (MemberPropertyName == GET_MEMBER_NAME_CHECKED(UBackgroundGlitchSubComponent, UIGlitchAnalogNoiseAndRGBSplitSet))
    {
        SetUIGlitchAnalogNoiseAndRGBSplitSet(UIGlitchAnalogNoiseAndRGBSplitSet);
    }
    else if (MemberPropertyName == GET_MEMBER_NAME_CHECKED(UBackgroundGlitchSubComponent, UIGlitchImageBlockSet))
    {
...
void UBackgroundGlitchSubComponent::OnPopulateMesh(FVertexHelper& VertexHelper)
{

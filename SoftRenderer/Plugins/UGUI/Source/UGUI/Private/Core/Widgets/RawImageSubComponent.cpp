...
/////////////////////////////////////////////////////
// URawImageSubComponent

URawImageSubComponent::URawImageSubComponent(const FObjectInitializer& ObjectInitializer)
...
void URawImageSubComponent::PreserveTextureAspectRatio(FRect& ViewRect, const FVector2D& TextureSize) const
{
...
FVector4 URawImageSubComponent::GetDrawingDimensions(bool bShouldPreserveAspect, FRect& OriginalViewRect)
{
...
DECLARE_CYCLE_STAT(TEXT("UIGraphic --- OnPopulateMesh"), STAT_UnrealGUI_Sub_RawImageOnPopulateMesh, STATGROUP_UnrealGUI);
void URawImageSubComponent::OnPopulateMesh(FVertexHelper& VertexHelper)
{
	SCOPE_CYCLE_COUNTER(STAT_UnrealGUI_Sub_RawImageOnPopulateMesh);
...
FVector2D URawImageSubComponent::GetNativeSize() 
{
	if (IsValid(Texture))
	{
...
float URawImageSubComponent::GetPreferredWidth()
{
	if (!IsValid(Texture))
		return 0;
...
float URawImageSubComponent::GetPreferredHeight()
{
	if (!IsValid(Texture))
		return 0;

#include "Core/Layout/HorizontalOrVerticalLayoutGroupSubComponent.h"
#include "Core/Layout/LayoutUtility.h"

/////////////////////////////////////////////////////
// UHorizontalOrVerticalLayoutGroupSubComponent

UHorizontalOrVerticalLayoutGroupSubComponent::UHorizontalOrVerticalLayoutGroupSubComponent(const FObjectInitializer& ObjectInitializer)
...
void UHorizontalOrVerticalLayoutGroupSubComponent::CalcAlongAxis(int32 Axis, bool bIsVertical)
{
...
void UHorizontalOrVerticalLayoutGroupSubComponent::SetChildrenAlongAxis(int32 Axis, bool bIsVertical)
{
    if (!IsValid(AttachTransform))
        return;
    
    const float Size = AttachTransform->GetRect().GetSize()[Axis];
    const bool bControlSize = (Axis == 0 ? bChildControlWidth : bChildControlHeight);
    const bool bUseScale = (Axis == 0 ? bChildScaleWidth : bChildScaleHeight);
...
void UHorizontalOrVerticalLayoutGroupSubComponent::GetChildSizes(URectTransformComponent* Child, int32 Axis, bool bControlSize, bool bChildForceExpand, float& Min, float& Preferred, float& Flexible) const
{
    if (!bControlSize)
    {

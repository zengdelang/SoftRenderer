...
/////////////////////////////////////////////////////
// UGridLayoutGroupComponent

UGridLayoutGroupComponent::UGridLayoutGroupComponent(const FObjectInitializer& ObjectInitializer)
...
void UGridLayoutGroupComponent::CalculateLayoutInputHorizontal()
{
...
void UGridLayoutGroupComponent::CalculateLayoutInputVertical()
{
    int32 MinRows = 0;
    if (Constraint == EGridLayoutConstraint::GridLayoutConstraint_FixedColumnCount)
    {
...
void UGridLayoutGroupComponent::SetLayoutHorizontal()
{
    SetCellsAlongAxis(0);
}

void UGridLayoutGroupComponent::SetLayoutVertical()
{
    SetCellsAlongAxis(1);
}

void UGridLayoutGroupComponent::SetCellsAlongAxis(int32 Axis)
{

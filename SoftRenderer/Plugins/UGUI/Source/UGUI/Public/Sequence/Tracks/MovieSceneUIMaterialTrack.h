...
#include "MovieSceneUIMaterialTrack.generated.h"

/**
 * Handles manipulation of material parameters in a movie scene.
 */
UCLASS()
class UGUI_API UMovieSceneUIMaterialTrack
...
public:
	...
	UMovieSceneUIMaterialTrack(const FObjectInitializer& ObjectInitializer);
...
class UMovieSceneUIComponentMaterialTrack
	: public UMovieSceneUIMaterialTrack

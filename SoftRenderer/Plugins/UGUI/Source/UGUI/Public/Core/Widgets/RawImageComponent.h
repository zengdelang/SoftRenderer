...
#include "RawImageComponent.generated.h"
 
UCLASS(Blueprintable, BlueprintType, ClassGroup = (Widget), meta = (UIBlueprintSpawnableComponent, BlueprintSpawnableComponent))
class UGUI_API URawImageComponent : public UMaskableGraphicComponent, public ILayoutElementInterface, public IRawImageElementInterface
{

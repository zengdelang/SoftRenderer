...
#include "UICascadeComponent.generated.h"

UCLASS(Blueprintable, BlueprintType, ClassGroup = (FX), meta = (UIBlueprintSpawnableComponent, BlueprintSpawnableComponent, DisplayName = "UI Cascade"))
class UGUI_API UUICascadeComponent : public UMaskableGraphicComponent, public IUICascadeElementInterface
{

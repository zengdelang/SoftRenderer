...
#include "ImageSubComponent.generated.h"

UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "Image"))
class UGUI_API UImageSubComponent : public UMaskableGraphicSubComponent, public ILayoutElementInterface, public ICanvasRaycastFilterInterface, public IImageElementInterface, public ISpriteTextureAtlasListenerInterface
{
...
protected:
	 ...
	 */
    UPROPERTY(EditAnywhere, Category = Graphic, meta = (ClampMin = "0", ClampMax = "1", UIMin = "0", UIMax = "1"))

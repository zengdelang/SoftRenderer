...
#include "BackgroundGlitchSubComponent.generated.h"

UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "Background Glitch"))
class UGUI_API UBackgroundGlitchSubComponent : public UMaskableGraphicSubComponent, public IBackgroundGlitchElementInterface
{
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = BackgroundGlitch)
	virtual void SetUIGlitchImageBlockSet(const FUIGlitchImageBlockSet& InUIGlitchImageBlockSetting)
	{
		UIGlitchImageBlockSet = InUIGlitchImageBlockSetting;
	}

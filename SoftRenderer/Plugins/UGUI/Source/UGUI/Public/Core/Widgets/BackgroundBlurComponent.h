...
#include "BackgroundBlurComponent.generated.h"

UCLASS(Blueprintable, BlueprintType, ClassGroup = (PostProcess), meta = (UIBlueprintSpawnableComponent, BlueprintSpawnableComponent))
class UGUI_API UBackgroundBlurComponent : public UMaskableGraphicComponent, public IBackgroundBlurElementInterface
{

...
class UGUI_API UTextComponent : public UMaskableGraphicComponent, public ILayoutElementInterface, public ITextElementInterface
{
...
protected:
	//~ Begin GraphicComponent Interface
	virtual void UpdateMaterial() override;
	virtual void UpdateGeometry() override;
	//~ End GraphicComponent Interface.
...
protected:
	UTextEmojiImageComponent* GenerateEmojiImageComponent();

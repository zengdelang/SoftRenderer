...
#include "UISimpleStaticMeshSubComponent.generated.h"

UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "UI Simple Static Mesh"))
class UGUI_API UUISimpleStaticMeshSubComponent : public UMaskableGraphicSubComponent, public ILayoutElementInterface, public IUISimpleStaticMeshElementInterface
{
